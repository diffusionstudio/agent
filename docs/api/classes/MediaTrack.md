...
[@diffusionstudio/core-v2](../globals.md) / MediaTrack

# Class: MediaTrack\<Clip\>

## Extends

- [`Track`](Track.md)\<[`MediaClip`](MediaClip.md)\>
...
• **Clip** *extends* [`MediaClip`](MediaClip.md)

## Constructors

### new MediaTrack()

> **new MediaTrack**\<`Clip`\>(): [`MediaTrack`](MediaTrack.md)\<`Clip`\>

#### Returns

[`MediaTrack`](MediaTrack.md)\<`Clip`\>
