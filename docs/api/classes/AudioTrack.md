...
[@diffusionstudio/core-v2](../globals.md) / AudioTrack

# Class: AudioTrack

## Extends

- [`MediaTrack`](MediaTrack.md)\<[`AudioClip`](AudioClip.md)\>

## Constructors

### new AudioTrack()

> **new AudioTrack**(): [`AudioTrack`](AudioTrack.md)
...
[src/tracks/audio/audio.ts:6](https://github.com/diffusionstudio/core-v2/blob/ce69ef92917fd6c7f2f6e872cf6c87954dee9b56/src/tracks/audio/audio.ts#L6)
